...
internal sealed partial class DesignerApplication
{
    ...
    [
        ...
        new(DesignerCommandId.FindSelection, "Source: Find selected text", () => sourceSearch.FindSelection(),
            CanExecute: () => sourceSearch.CanFindSelection),
        new(DesignerCommandId.FindSelectionNext, "Source: Find next occurrence of selected text", () => sourceSearch.FindSelection(navigate: true),
            "Ctrl+F3 in source", () => sourceSearch.CanFindSelection),
        new(DesignerCommandId.FindSelectionPrevious, "Source: Find previous occurrence of selected text",
            () => sourceSearch.FindSelection(navigate: true, reverse: true), "Ctrl+Shift+F3 in source", () => sourceSearch.CanFindSelection),
        ...
        new(DesignerCommandId.DuplicateSourceLines, "Source: Duplicate selected lines", sourceLines.Duplicate, "Shift+Alt+Down in source",
            () => !editor.ReadOnly),
        new(DesignerCommandId.MoveSourceLinesUp, "Source: Move selected lines up", () => sourceLines.Move(down: false), "Alt+Up in source",
        ...
        new(DesignerCommandId.ExpandHierarchy, "Hierarchy: Expand selected subtree", workspace.ExpandHierarchy,
            CanExecute: () => workspace.CanExpandHierarchy),
        new(DesignerCommandId.CollapseHierarchy, "Hierarchy: Collapse selected branch", workspace.CollapseHierarchy,

...
unsafe extern "C" {
    ...
    pub fn xui_navigation_hover_help(target: u64, id: u64, text: Text, applied: *mut u32) -> i32;
    pub fn xui_navigation_hover_delay(target: u64, milliseconds: u32) -> i32;
    ...
    pub fn xui_window_set_icon_source(window: u64, path: Text) -> i32;
    pub fn xui_window_on_icon_error(
        window: u64,
        callback: WindowIconErrorCallback,
        context: *mut c_void,
    ) -> i32;

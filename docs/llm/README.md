...
- [Explorer history](explorer-history.md): File views, lazy Tree requests, folder identity, Find input, navigation menus and hover cards, tab icons, and thumbnails.

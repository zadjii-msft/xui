...
- [Explorer history](explorer-history.md): Breadcrumb address composition, folder identity, Find input, navigation menus and hover cards, tab icons, compact headers, and thumbnails.

...
void sizing_and_scroll() {
    static_assert(static_cast<int>(ButtonIcon::drive) == 21 &&
        static_cast<int>(ButtonIcon::save) == 22 && static_cast<int>(ButtonIcon::save_as) == 23 &&
        static_cast<int>(ButtonIcon::undo) == 24 && static_cast<int>(ButtonIcon::redo) == 25 &&
        static_cast<int>(ButtonIcon::chevron_up) == 26 && static_cast<int>(ButtonIcon::chevron_down) == 27);
